...
sed --regexp-extended --in-place "s/JAVA_VERSION=[^ ]+/JAVA_VERSION=${latestGraal17}/" ./jdk17*graal/Dockerfile
...
sed --regexp-extended --in-place "s/JAVA_VERSION=[^ ]+/JAVA_VERSION=${latestGraal21}/" ./jdk21*graal/Dockerfile
