...
sed --regexp-extended --in-place "s/JAVA_VERSION=[^ ]+/JAVA_VERSION=${graal22Version}/" ./jdk22-graal/Dockerfile
sed --regexp-extended --in-place "s/GRAALVM_AMD64_DOWNLOAD_SHA256=[^ ]+/GRAALVM_AMD64_DOWNLOAD_SHA256=${graal22amd64Sha}/" ./jdk22-graal/Dockerfile
sed --regexp-extended --in-place "s/GRAALVM_AARCH64_DOWNLOAD_SHA256=[^ ]+/GRAALVM_AARCH64_DOWNLOAD_SHA256=${graal22aarch64Sha}/" ./jdk22-graal/Dockerfile
...
sed --regexp-extended --in-place "s/JAVA_22_VERSION=[^ ]+/JAVA_22_VERSION=${graal22Version}/" ./jdk-lts-and-current-graal/Dockerfile
sed --regexp-extended --in-place "s/GRAALVM_22_AMD64_DOWNLOAD_SHA256=[^ ]+/GRAALVM_22_AMD64_DOWNLOAD_SHA256=${graal22amd64Sha}/" ./jdk-lts-and-current-graal/Dockerfile
sed --regexp-extended --in-place "s/GRAALVM_22_AARCH64_DOWNLOAD_SHA256=[^ ]+/GRAALVM_22_AARCH64_DOWNLOAD_SHA256=${graal22aarch64Sha}/" ./jdk-lts-and-current-graal/Dockerfile
